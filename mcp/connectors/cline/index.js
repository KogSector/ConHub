...
class ClineConnector extends BaseConnector {
  constructor(config = {}) {
    super(config);
  ...
  async register(core) {
    try {
      ...
      this.log('info', 'Cline connector registered successfully');
      return true;
    } catch (error) {
      this.log('error', 'Failed to register cline connector', { error: error.message });
      throw error;
    }
  }
  ...
  async initialize(config = {}) {
    try {
      ...
      this.log('info', 'Cline connector initialized');
      return true;
    } catch (error) {
      this.log('error', 'Failed to initialize cline connector', { error: error.message });
      throw error;
    }
  }
  ...
  async cleanup() {
    try {
      ...
      this.log('info', 'Cline connector cleaned up');
    } catch (error) {
